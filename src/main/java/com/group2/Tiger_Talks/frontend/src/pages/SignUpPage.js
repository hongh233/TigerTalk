...
const SignUpPage = () => {
  ...
  const validate = () => {
    ...
    else if (!Number.isInteger(Number(form.age))) errors.age = "Age must be an integer";
    if (!form.gender) errors.gender = "Gender is required";
    if (!form.userName) errors.userName = "User name is required";
    if (!form.bannerID) errors.bannerID = "Banner ID is required";
    else if (!Number.isInteger(Number(form.bannerID))) errors.bannerID = "Banner ID must be an integer";
    if (!form.email) errors.email = "Email is required";
    if (!form.password) errors.password = "Password is required";
    if (form.password !== form.confirmPassword) errors.confirmPassword = "Passwords do not match";
    if (!form.securityQuestion1) errors.securityQuestion1 = "Security question 1 is required";
    if (!form.securityAnswer1) errors.securityAnswer1 = "Answer for security question 1 is required";
    if (!form.securityQuestion2) errors.securityQuestion2 = "Security question 2 is required";
    if (!form.securityAnswer2) errors.securityAnswer2 = "Answer for security question 2 is required";
    if (!form.securityQuestion3) errors.securityQuestion3 = "Security question 3 is required";
    if (!form.securityAnswer3) errors.securityAnswer3 = "Answer for security question 3 is required";
    return errors;
  };
      ...
      if (error.response && error.response.data) {
        ...
        switch (errorMessage) {
          case "Username has already existed!":
            serverErrors.userName = "Username has already existed!";
            break;
          case "Invalid Banner ID. Please input number between 0-999999":
            serverErrors.bannerID = "Invalid Banner ID. Please input number between 0-999999";
            break;
          case "Banner ID has already existed!":
            serverErrors.bannerID = "Banner ID has already existed!";
            break;
          case "Invalid email address. Please use dal email address!":
            serverErrors.email = "Invalid email address. Please use dal email address!";
            break;
          case "Email has already existed!":
            serverErrors.email = "Email has already existed!";
            break;
          case "Password must have a minimum length of 8 characters.":
            serverErrors.password = "Password must have a minimum length of 8 characters.";
            break;
          case "Password must have at least 1 uppercase character.":
            serverErrors.password = "Password must have at least 1 uppercase character.";
            break;
          case "Password must have at least 1 lowercase character.":
            serverErrors.password = "Password must have at least 1 lowercase character.";
            break;
          case "Password must have at least 1 number.":
            serverErrors.password = "Password must have at least 1 number.";
            break;
          case "Password must have at least 1 special character.":
            serverErrors.password = "Password must have at least 1 special character.";
            break;
          default:
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <input
              type="text"
              name="bannerID"
              placeholder="Banner ID (Without B00)"
              value={form.bannerID}
              onChange={handleChange}
            />
          ...
          <div className="form-group">
            <input
              ...
              onChange={handleChange}
            />
            {errors.securityAnswer3 && <p className="error">{errors.securityAnswer3}</p>}
          </div>
